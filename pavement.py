...
BUNDLE_ID = 'ch.mibex.bamboo.alfred-workflow'

install_distutils_tasks()

options(
    setup=dict(
        name="Alfred-Bamboo-Workflow",
        packages=['workflow'],
        version="1.0.0",
...
def lint():
    """Lint Python files"""
    return sh('flake8 workflow/test workflow/src/actions workflow/src/bamboo pavement.py')
...
def test():
    ...
    sh("nosetests -w workflow -d -v test")
